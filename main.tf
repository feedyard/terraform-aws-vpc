...
# create public subnets if defined
...
# create private subnets if defined
...
# private subnets can be defined to route through nat-gws located in the public subnets - matched to az
...
# create databse subnets if defined
...
# define elasticache subnets if defined
